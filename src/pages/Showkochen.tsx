  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Erleben Sie ein unvergessliches Showkochen mit dem Thermomix in Wien, Niederösterreich und Burgenland." />
      </Helmet>
          ...
          <div className="section-padding">
            <div className="container-narrow">
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-foreground mb-6 animate-fade-up">
                <span className="text-primary">Showkochen</span>
              </h1>
